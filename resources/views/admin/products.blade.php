    ...
    <div class="flex flex-1">
        ...
        <div class="flex-1 bg-base-300">
            ...
            <div class="overflow-x-auto m-8">
                ...
                <button class="btn btn-success mb-5 float-right " onclick="my_modal_3.showModal()">Add Coffees</button>
                
                {{-- Modal --}}
                    <dialog id="my_modal_3" class="modal">
                      <div class="modal-box">
                        <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onclick="closeModal('my_modal_3')">✕</button>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>                          
                          ...
                          onclick="openEditModal({{ $coffee->id }}, '{{ $coffee->productName }}', '{{ $coffee->description }}', {{ $coffee->price }}, '{{ $coffee->size }}', '{{ $coffee->image }}')">
                          Edit
                        </button>
                        ...
                        <td>
                          <a href="{{ url('delete_coffee', $coffee->id) }}" onclick="confirm(event)" class="btn btn-error">Delete</a>
            ...
            <dialog id="my_modal_4" class="modal">
              <div class="modal-box">
                  <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onclick="closeModal('my_modal_4')">✕</button>
...
<script>
  function openEditModal(id, name, description, price, size, image) {
     ...
     document.getElementById('my_modal_4').showModal();
      ...
      document.getElementById('editProductForm').action = `/update_coffee/${id}`;
